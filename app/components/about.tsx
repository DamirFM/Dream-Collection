...
export default function AboutComponent() {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-0 mt-3 md:mt-8 sm:mt-5 lg:justify-center items-center">
            {/* Header Section */}
            <div className="text-stone-700 text-center font-semibold mt-4 sm:mt-0 fade-in w-full lg:col-span-2">
                <div
            ...
            <div className="grid grid-rows-2 gap-4 w-full lg:w-2/3 lg:-ml-10">
                {/* Text Paragraph */}
            ...
            <div className="flex justify-center lg:justify-end lg:items-start w-full lg:w-1/3">
                <SwipeCards />
            </div>
        </div>
    );
