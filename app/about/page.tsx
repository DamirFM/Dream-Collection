...
export default function About() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full min-h-screen p-4 ">
            ...
            <div className="bg-[#D7C3F1] absolute top-[-6rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[28rem] xl:left-[15rem] 2xl:left-[-5rem] dark:bg-slate-800"></div>
            ...
            <div className="w-full max-w-3xl p-8 rounded-xl shadow-sm mb-8 dark:text-stone-100 ">
                ...
                <p className="text-center text-lg mb-4">
                    ...
                    inspiration. This platform allows users to share, explore, and
                    appreciate visual arts from creators all around the world. Our goal is
                    to foster a community of visual storytellers and inspire through
                    imagery.
                </p>
            </div>
            ...
            <div className="w-full max-w-3xl p-8 rounded-smhadow-md mb-8 dark:text-stone-100 ">
                ...
                <p className="text-justify mb-4">
                    ...
                    respective licenses. We do not claim ownership over any content shared
                    by our users. By uploading images, users agree that they have the
                    right to distribute these images and that they are not infringing on
                    any third-party rights. The platform is not responsible for any
            ...
            <div className="w-full max-w-3xl p-8  rounded-sm shadow-md mb-8 dark:text-stone-100">
                ...
                <p className="text-justify mb-4">
                    ...
                    information. Our platform collects minimal data necessary for account
                    creation and user interaction. We do not sell or share your personal
                    information with third parties except as required by law. Users are
                    encouraged to review our full privacy policy to understand how their
            ...
            <div className="w-full max-w-3xl p-8  rounded-xl shadow-md mb-8 dark:text-stone-100">
                ...
                <p className="text-justify mb-4">
                    ...
                    includes respecting the intellectual property rights of others,
                    refraining from posting harmful or offensive content, and complying
                    with all applicable laws and regulations. The use of free shared
                    images is permitted as long as proper credit is given to the creators,
                    and usage adheres to the specified licenses of the images.
                </p>
                <p className="text-justify">
                    We reserve the right to remove any content that violates our terms of
                    use and to terminate the accounts of users who engage in prohibited
                    activities. Please review our full terms of service for detailed
                    information.
                </p>
            </div>
